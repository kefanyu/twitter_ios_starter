...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "n6mcmjlekgHAx3OxzjjgyKxnG", consumerSecret: "ZCI7MJe30wMevRKbFeVcMM1iQc2kt1swemt4bxC39SRqFP2cec")
    var loginSuccess: (() -> ())?
